function findCaliforniaCafes(searchTerm) {
    // Define the cafes and places arrays
    const cafes = [
    ...
    // Filter cafes by name containing the searched term as a substring
    const matchedCafes = cafes.filter(cafe => cafe.name.toLowerCase().includes(searchTerm.toLowerCase()));

    // Map the matched cafes to their corresponding place details
